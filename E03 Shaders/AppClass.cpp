...
void AppClass::Display(void)
{
	...
	GLuint ComplimentaryColors = glGetUniformLocation(m_uShaderProgramID, "ComplimentaryEnabled");
	glUniform1i(ComplimentaryColors, complimentOn);
